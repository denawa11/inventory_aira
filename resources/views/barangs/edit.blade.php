        ...
        <form method="POST" action="{{ route('barangs.update', $barang) }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="colour_number" class="form-control" value="{{ old('colour_number', $barang->colour_number) }}">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="colour" class="form-control" value="{{ old('colour', $barang->colour) }}">
                </div>
                <div class="col-md-3">
                    <label class="form-label">Stock</label>
                    <input type="number" name="stock" class="form-control" value="{{ old('stock', $barang->stock) }}">
                </div>
                <div class="col-md-3">
                    <label class="form-label">Stock Minimum</label>
                    <input type="number" name="stock_minimum" class="form-control" value="{{ old('stock_minimum', $barang->stock_minimum) }}">
                </div>
                <div class="col-md-12">
                    <div class="form-check">
                        <input type="checkbox" name="opened" value="1" class="form-check-input" {{ $barang->opened ? 'checked' : '' }}>
